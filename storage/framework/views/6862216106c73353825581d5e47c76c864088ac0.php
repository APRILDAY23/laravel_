...
?>    
    ...
    <body onload="myFunction()">
        <h1>Admin Page</h1>
        <a href="<?php echo e(route('announce')); ?>"><button id="announce">+ Add A Announcement</button></a>
<div id="box" loading="eager">
    <h1 id="user">User Information</h1>
        <div id="table">
            ...
            <table id="table1">
                ...
                <tbody>
                    <tr>
                        <td><?php echo e($LoggedUserInfo['fname']); ?></td>
                        <td><?php echo e($LoggedUserInfo['lname']); ?></td>
                        <td><?php echo e($LoggedUserInfo['email']); ?></td>
                        <td><a href="<?php echo e(route('logout')); ?>">Logout</a></td>
                    </tr>
                </tbody>
            </table>
                    ...
                    <tr id="row">
                        <?php
                            ...
                            <td><?php echo $row['description']?></td>
                                <form action="<?php echo e(url('delete/'.$row['id'])); ?>" method="post">
                                        <?php echo csrf_field(); ?>
                                        ...
                                        <form action="<?php echo e(url('edit/'.$row['id'])); ?>" method="GET">
                                            <?php echo csrf_field(); ?>
    ...
    </html><?php /**PATH D:\XAMMP\htdocs\Larvaral_project\resources\views/admin.blade.php ENDPATH**/ ?>